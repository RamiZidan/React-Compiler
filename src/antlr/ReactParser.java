...
public class ReactParser extends Parser {
	...
	public static final int
		...
		RULE_assignStatment = 27, RULE_operation = 28, RULE_useEffect = 29, RULE_dependancyList = 30, 
		RULE_useState = 31, RULE_useRef = 32, RULE_varDeclarationStatment = 33, 
		RULE_variable = 34, RULE_array = 35, RULE_object = 36, RULE_number = 37, 
		RULE_string = 38, RULE_equation = 39, RULE_varModifier = 40, RULE_eos = 41, 
		RULE_jsxElement = 42, RULE_jsxTagName = 43, RULE_jsxAttName = 44, RULE_jsxAttValue = 45, 
		RULE_jsxAtt = 46, RULE_jsxEleContent = 47, RULE_singleExpression = 48, 
		RULE_arrayJsx = 49, RULE_callbackFunction = 50;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"assignStatment", "operation", "useEffect", "dependancyList", "useState", 
			"useRef", "varDeclarationStatment", "variable", "array", "object", "number", 
			"string", "equation", "varModifier", "eos", "jsxElement", "jsxTagName", 
	...
	public final UseEffectContext useEffect() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_useEffect);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final DependancyListContext dependancyList() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_dependancyList);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(369);
	...
	public final UseStateContext useState() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_useState);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final UseRefContext useRef() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_useRef);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final VarDeclarationStatmentContext varDeclarationStatment() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_varDeclarationStatment);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	private EquationContext equation(int _p) throws RecognitionException {
		...
		int _startState = 78;
		enterRecursionRule(_localctx, 78, RULE_equation, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
